...
export const metadata: Metadata = {
  title: "Handyman Services in Fort Worth, TX | Creative Constructors",
  description: "Professional handyman and home repair services in Fort Worth, TX. Licensed & insured. Electrical, plumbing, HVAC, carpentry & more. Same-day service available. Call (817) 470-1889.",
  keywords: [
    "handyman Fort Worth",
    "Fort Worth handyman",
    "home repair Fort Worth TX",
  ...
  openGraph: {
    title: "Handyman Services in Fort Worth, TX | Creative Constructors",
    description: "Professional handyman and home repair services in Fort Worth, TX. Licensed & insured. Same-day service available.",
    url: "/service-areas/fort-worth",
  },
};
...
export default function FortWorthPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-navy via-royal-blue to-navy text-white py-20 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-6xl font-black font-barlow-condensed mb-6">
            Fort Worth's Trusted Handyman Service
          </h1>
          <p className="text-xl md:text-2xl text-silver mb-8">
            Professional Home Services Throughout Fort Worth, TX
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <p className="text-gray-700">
                Same-day service available for Fort Worth residents. We understand your time is valuable.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              <div className="text-5xl mb-4">✅</div>
              ...
              <p className="text-gray-700">
                Fully licensed, insured, and background-checked professionals serving Fort Worth since 2010.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              <div className="text-5xl mb-4">⭐</div>
              ...
              <p className="text-gray-700">
                Hundreds of 5-star reviews from satisfied Fort Worth homeowners and businesses.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-center text-gray-600">
            Don't see your neighborhood? We serve all of Fort Worth and surrounding areas.{" "}
      ...
      {/* About Fort Worth Service */}
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black font-barlow-condensed text-navy mb-8">
            Your Local Fort Worth Handyman
          </h2>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 mb-4">
              Creative Constructors LLC is proud to serve homeowners and businesses throughout Fort Worth, Texas. 
              As a locally-operated handyman service, we understand the unique needs of Fort Worth properties - 
              from historic homes in Fairmount to modern residences in Tanglewood.
            </p>
            <p className="text-gray-700 mb-4">
              Whether you need emergency electrical repairs near TCU, plumbing services in the Cultural District, 
              or HVAC maintenance in Arlington Heights, our experienced team is ready to help. We offer same-day 
              service for urgent repairs and flexible scheduling for routine maintenance.
            </p>
            <p className="text-gray-700 mb-4">
              Our Fort Worth customers appreciate our:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
              ...
              <li>Expert knowledge of Fort Worth building codes and requirements</li>
