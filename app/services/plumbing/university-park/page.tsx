...
export const metadata: Metadata = {
  title: "Plumber in University Park, TX | Licensed Plumbing Services",
  description: "Licensed plumber serving University Park, TX. Leak repairs, drain cleaning, fixture installation, water heaters, sewer lines. 15+ years experience. Same-day service. Call (817) 470-1889.",
  keywords: [
    "plumber University Park TX",
    "University Park plumber",
    "plumbing services University Park",
    "leak repair University Park",
    "licensed plumber University Park",
    "emergency plumber University Park",
    "drain cleaning University Park",
    "water heater University Park",
  ],
  openGraph: {
    title: "Plumber in University Park, TX | Creative Constructors",
    description: "Licensed plumbing services for University Park homes. Leak repairs, drain cleaning, installations. Same-day service available.",
    url: "/services/plumbing/university-park",
  },
};

export default function PlumbingUniversityParkPage() {
  ...
  const nearbyAreas = [
    { name: "Highland Park", href: "/services/plumbing/highland-park" },
  ...
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-6">
                Expert plumbing services for University Park homes. Fast, reliable, and professional. We handle everything from leaky faucets to complete system upgrades.
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-200">Licensed, insured, trusted since 2011</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange text-xl">✓</span>
                  <span className="text-gray-200">Same-day emergency plumbing service</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange text-xl">✓</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-orange text-xl">✓</span>
                  <span className="text-gray-200">Clean, professional, respectful service</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-4xl font-bold mb-12 text-navy text-center">Plumbing Services in University Park</h2>
          ...
          <div className="mt-12 bg-gradient-to-br from-orange/10 to-orange/5 rounded-xl p-8 border-2 border-orange/20">
            <h3 className="text-2xl font-bold text-navy mb-4">Emergency Plumbing? We're Here 24/7</h3>
            <p className="text-gray-700 mb-4">
              Burst pipes, major leaks, and plumbing emergencies can't wait. Call us for immediate assistance.
            </p>
      ...
      <section className="py-16 px-4 bg-royal-blue text-white">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-4xl font-bold mb-6">Need a Plumber in University Park?</h2>
