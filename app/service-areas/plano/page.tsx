...
export const metadata: Metadata = {
  title: "Handyman Services in Plano, TX | Creative Constructors",
  description: "Professional handyman and home repair services in Plano, TX. Licensed & insured. Electrical, plumbing, HVAC, carpentry & more. Same-day service available. Call (817) 470-1889.",
  keywords: [
    "handyman Plano",
    "Plano handyman",
    "home repair Plano TX",
    "electrician Plano",
    "plumber Plano",
    "HVAC Plano",
    "Plano home services",
  ...
  openGraph: {
    title: "Handyman Services in Plano, TX | Creative Constructors",
    description: "Professional handyman and home repair services in Plano, TX. Licensed & insured. Same-day service available.",
    url: "/service-areas/plano",
  },
};
      ...
      <section className="bg-gradient-to-br from-navy via-royal-blue to-navy text-white py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="inline-block bg-orange/20 backdrop-blur-sm border border-orange/30 rounded-full px-6 py-2 mb-6">
            <span className="text-orange font-bold">📍 Serving Plano, TX</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-black font-barlow-condensed mb-6">
            Professional Handyman Services in Plano, Texas
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl">
            Your trusted local handyman serving Plano and surrounding areas. Licensed, insured, and ready to help with all your home repair and improvement needs.
          </p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-black font-barlow-condensed text-navy mb-12 text-center">
            Why Plano Residents Choose Creative Constructors
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Same-day service available for emergency repairs in Plano</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-orange/10 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Serving Plano homeowners with 5-star rated service</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-xl text-gray-600 mb-12 text-center">
            Comprehensive home services for Plano residents
          </p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-gray-600 mb-8 text-center">
            Proudly serving homeowners throughout Plano and surrounding communities
          </p>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-navy to-royal-blue text-white">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black font-barlow-condensed mb-6 text-center">
            Your Local Plano Handyman
          </h2>
          <div className="prose prose-lg prose-invert mx-auto">
            <p className="text-gray-300 text-center mb-6">
              Creative Constructors has been serving homeowners in Plano, TX with reliable, professional handyman services. From routine maintenance to emergency repairs, we're your trusted partner for keeping your Plano home in perfect condition.
            </p>
            <p className="text-gray-300 text-center mb-6">
              Whether you live in West Plano, Legacy West, or anywhere in the Plano area, we're ready to help with electrical work, plumbing repairs, HVAC maintenance, smart home installations, and much more.
            </p>
          </div>
          <div className="text-center mt-8">
            ...
            >
              Call for Service in Plano: (817) 470-1889
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-orange">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Book your handyman service in Plano today
          </p>
