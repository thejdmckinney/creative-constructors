...
export const metadata: Metadata = {
  title: "Handyman Services in Richardson, TX | Creative Constructors",
  description: "Professional handyman and home repair services in Richardson, TX. Licensed & insured. Electrical, plumbing, HVAC, carpentry & more. Same-day service available. Call (817) 470-1889.",
  keywords: [
    "handyman Richardson",
    "Richardson handyman",
    "home repair Richardson TX",
    "electrician Richardson",
    "plumber Richardson",
    "HVAC Richardson",
    "Richardson home services",
  ],
  openGraph: {
    title: "Handyman Services in Richardson, TX | Creative Constructors",
    description: "Professional handyman and home repair services in Richardson, TX. Licensed & insured. Same-day service available.",
    url: "/service-areas/richardson",
  },
};
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-black font-barlow-condensed text-navy mb-12 text-center">
            Why Richardson Residents Choose Creative Constructors
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Same-day service available for emergency repairs in Richardson</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-orange/10 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Serving Richardson homeowners with 5-star rated service</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-xl text-gray-600 mb-12 text-center">
            Comprehensive home services for Richardson residents
          </p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-gray-600 mb-8 text-center">
            Proudly serving homeowners throughout Richardson and surrounding communities
          </p>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-navy to-royal-blue text-white">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-black font-barlow-condensed mb-6 text-center">
            Your Local Richardson Handyman
          </h2>
          <div className="prose prose-lg prose-invert mx-auto">
            <p className="text-gray-300 text-center mb-6">
              Creative Constructors has been serving homeowners in Richardson, TX with reliable, professional handyman services. From routine maintenance to emergency repairs, we're your trusted partner for keeping your Richardson home in perfect condition.
            </p>
            <p className="text-gray-300 text-center mb-6">
              Whether you live in Canyon Creek, Spring Valley, or anywhere in the Richardson area, we're ready to help with electrical work, plumbing repairs, HVAC maintenance, smart home installations, and much more.
            </p>
          </div>
          <div className="text-center mt-8">
            ...
            >
              Call for Service in Richardson: (817) 470-1889
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-orange">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Book your handyman service in Richardson today
          </p>
